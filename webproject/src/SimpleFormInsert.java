   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      while (rs.next()) {
          ...
          if (scientificName.isEmpty() || scientificName.contains(scientificName)) {
             out.println("Gene Name: " + geneName + "<br>");
             out.println("Scientific Name: " + sciName + "<br>");
             out.println("Sequence Length: " + sequenceLen + "<br>");
             out.println("Sequence Location: " + source + "<br>");
             out.println("Acc Number: " + geneSymbol + "<br>");
             out.println("SEQUENCE:<br>" + parsedStr+ "<br>");
          }
       }
      }
